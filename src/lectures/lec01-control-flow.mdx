...
when needed. They include conditional execution, loops, function calls
and exceptions.
...
Refer to the section on [Equality and Identity](./lec07-equality-and-identity.html) for more details.
...
<Admonition type="note" title="Numbers and Collections" open={true}>
...
Refer to the section on [Iteration and Comprehension](./lec08-iteration-and-comprehension.html) for more details.
...
<Admonition type="note" title="Terminal and Errors" open={true}>
